...
impl Plugin for ExtractPlugin {
    fn build(&self, app: &mut App) {
        ...
        // remote-webgpu: claim this render world's sync record queue.
        let sync_queue = crate::sync_world::register_render_world(app.world_mut());
        render_app
            .world_mut()
            .insert_resource(crate::sync_world::SyncQueueIndex(sync_queue));
