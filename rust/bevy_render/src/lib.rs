...
impl Plugin for RenderPlugin {
    ...
    fn build(&self, app: &mut App) {
        ...
        // remote-webgpu: the render worlds are paced per player by their
        // browsers' vsync and regularly skip main-app ticks, so the main
        // world keeps its own clock instead of draining a render-time
        // channel that would be empty most ticks.
