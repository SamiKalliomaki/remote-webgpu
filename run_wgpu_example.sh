...
# The upstream release the compatible crates were written against; the
# wgpu crate in ./rust implements the wgpu 29 API on top of the real
# wgpu-types 29 crate (the same versions the bevy 0.19 crates use).
WGPU_REPO=https://github.com/gfx-rs/wgpu.git
WGPU_REV=e99f5305ded96ff7006f0714d043a7f735bd45c2  # v29.0.4
...
UNSUPPORTED="ray_cube_compute ray_cube_fragment ray_cube_normals ray_scene ray_shadows ray_traced_triangle mesh_shader cooperative_matrix multiview"
